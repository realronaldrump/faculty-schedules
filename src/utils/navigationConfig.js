    ...
    children: [
      {
        ...
        sidebarChildren: [
          {
            id: "faculty-compare-schedules",
            label: "Compare Schedules",
            path: "scheduling/faculty?tab=compare",
            accessId: "scheduling/faculty",
            description: "Compare faculty schedules side by side.",
            icon: ArrowLeftRight,
          ...
          },
          {
            ...
            label: "Availability",
            path: "scheduling/faculty?tab=availability",
            accessId: "scheduling/faculty",
            description: "Find an individual faculty member's availability.",
            icon: Clock,
          },
          {
            id: "faculty-group-meetings",
            label: "Group Meetings",
            path: "scheduling/faculty?tab=meetings",
            accessId: "scheduling/faculty",
            description: "Find shared meeting times for a group.",
            icon: Users,
          },
        ],
      },
        ...
        sidebarChildren: [
          {
            id: "rooms-browse",
            label: "Browse",
            path: "scheduling/rooms?tab=browse",
            accessId: "scheduling/rooms",
            description: "Browse room schedules and availability.",
            icon: Building,
            defaultForParent: true,
          },
          {
            ...
            label: "Reservations",
            path: "scheduling/rooms?tab=reservations",
            accessId: "scheduling/rooms",
            description: "Manage room reservation requests.",
            icon: ClipboardList,
          },
        ],
      },
      ...
      },
      {
        ...
        sidebarChildren: [
          {
            id: "student-worker-schedules",
            label: "Schedules",
            path: "scheduling/student-workers?tab=schedule",
            accessId: "scheduling/student-workers",
            permissions: {
              hideFromRoles: ["faculty"],
            },
            description: "Review student worker schedules.",
            icon: UserCheck,
            defaultForParent: true,
          },
          {
            id: "student-worker-payroll",
            label: "Payroll",
            path: "scheduling/student-workers?tab=payroll",
            accessId: "scheduling/student-workers",
            permissions: {
              hideFromRoles: ["faculty"],
            },
            description: "Review payroll insights for student workers.",
            icon: BarChart3,
          },
        ],
      },
